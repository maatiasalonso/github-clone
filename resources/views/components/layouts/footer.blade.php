<footer class="container mx-auto text-xs border-t border-gray-400 py-10 flex flex-col lg:flex-row justify-center">
    <div class="hidden lg:block">
        <div class="flex space-x-1">
            ...
            <span class="px-1 mt-1">&copy; 2022 GitHub, Inc.</span>
            <ul class="flex space-x-6 lg:space-x-8 mt-1 px-4">
